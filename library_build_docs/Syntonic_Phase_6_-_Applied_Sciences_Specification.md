...
class BandStructure:
    ...
    BAND_GAPS = {
        ...
        'GaAs':    (3,  1.42),    # E* × 3 × q = 1.644 eV, exp: 1.42 eV
        'Si':      (2,  1.12),    # E* × 2 × q = 1.096 eV, exp: 1.12 eV (2.1%)
        'Ge':      (1,  0.67),    # E* × 1 × q = 0.548 eV, exp: 0.67 eV
    }
...
class KleiberLaw:
    ...
    The interface between internal (T⁴) and external (M⁴) domains
    controls metabolic scaling.
    """
...
class NeuralAntennaModel:
    ...
    def specious_present(self) -> float:
        """
        The "now" duration: T_now ≈ 3π/f_γ ≈ 3 seconds
        
        This matches psychological studies of the perceived present.
        """
        return 3 * np.pi / self.GAMMA_FREQUENCY
...
class TrophicDynamics:
    ...
    Trophic efficiency: η = φ⁻⁵ ≈ 9% (compounded DHSR losses)
...
| Consciousness Threshold | ΔS > 24 (K = 24) | Physics_of_Consciousness.md §11 |
...
*Syntonic Phase 6 Specification v1.0*  
*December 2025*
